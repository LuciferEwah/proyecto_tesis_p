...
class MedidaCautelar:
    def __init__(self, id_evento: int,
                 tipo_medida: str,
                 respuesta: str,
                 plazo: str,
                 ):
        # Asumiendo que es un valor que se asigna automáticamente
        self.id_medida_cautelar = None
        self.id_evento = id_evento
        self.respuesta = self.normalizar_texto(respuesta)
        self.tipo_medida = self.normalizar_texto(tipo_medida)
        self.plazo = self.normalizar_texto(plazo)
...
class MedidaCautelarEspecial(MedidaCautelar):
    def __init__(self, id_evento: int,
                 tipo_medida: str,
                 respuesta: str,
                 plazo: str,
                 interpone_recurso: str,
                 demanda_reconvencional: str,
                 ):
        super().__init__(id_evento, tipo_medida, respuesta, plazo)
        self.interpone_recurso = self.normalizar_texto(interpone_recurso)
        self.demanda_reconvencional = self.normalizar_texto(demanda_reconvencional)
